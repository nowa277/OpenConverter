...
const TRANSLATIONS = {
  en: {
    ...
    about_title: 'About',
    about_desc1: 'OpenConverter is an open-source audio format converter. Decryption and transcoding stay local; lyrics may GET the song id unless the switch is off. No audio is uploaded.',
  ...
  zh: {
    ...
    about_title: '关于',
    about_desc1: 'OpenConverter 是一款跨平台轻量级音频格式转换与本地解码工具。解密与转码在本地完成；歌词默认可能按歌曲 id 向网易请求（可关闭）。不上传音频。',
